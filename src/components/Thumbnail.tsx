...
const Thumbnail: React.FC<{ project: ProjectData }> = ({ project }) => (
	<Card className="bg-secondary border-primary border-3 h-100">
		...
		<Card.Body className="d-flex flex-column justify-content-between">
			<Card.Title className="d-flex justify-content-center fs-2 bg-dark p-2 rounded"> {project.name} </Card.Title>
